...
const Footer = ({ setFilter, setSearchQuery }) => {
  return (
    ...
    <footer class="d-flex flex-wrap align-items-center py-3 my-4">
    <div className='justify-content-between d-flex ms-lg-5'>
    <div id='foot' class="col-sm-1 d-flex">
      <a href="/" class="mb-3 me-2 mb-md-0 text-body-secondary text-decoration-none lh-1">
      <img id='logo1' className='logo' src={require("../images/logo.png")} alt="" />
    </a>
    </div>
